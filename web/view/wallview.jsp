...
<%
    ...
    MessageWall_and_RemoteLogin_Impl mw_rl = (MessageWall_and_RemoteLogin_Impl) 
            request.getServletContext().getAttribute("remoteLogin");
...
<body>
    ...
    <h2> <%=mw_rl.getNumber() %> Messages shown:</h2>
    ...
    <table width="50%" border="1" bordercolordark="#000000" bordercolorlight="#FFFFFF" cellpadding="3" cellspacing="0">
        ...
        <%
            int index = 0;
            for (Message msg : mw_rl.getAllMessages()) {
        %>
...
<form action="refresh.do" method="POST" type="hidden">
    <button hidden="hidden" name="refresh_button"></button>
</form>
